...
simplehook.so: main.c
	...
	g++ -g speed_calculator.cpp netstat_plugin.cpp -o libnetstat_plugin.so --shared -fPIC libcommon.a
	  g++ -fpermissive   -Ifunhook/include -g -ILuaJIT-2.0.5/src lua_mem_tool.cpp -o liblua_perf_tool.so --shared -fPIC -fvisibility=hidden -m64 -Wno-missing-braces -D_GNU_SOURCE -DPFB_NO_EXTERNAL_FUNC -DPFB_MSVC_FORMAT libcommon.a LuaJIT-2.0.5/src/libluajit.a  -lpthread -ldl -lm
